...
namespace Common.Model
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentNotEmptyGuid(Guid guid, string message)
        {
            if (guid == Guid.Empty)
            {
                throw new InvalidOperationException(message);
        ...
        protected void SelfAssertArgumentNotEmptyGuid(Guid guid, string message)
        {
            AssertionConcern.AssertArgumentNotEmptyGuid(guid, message);
        }
